<template>
  <q-page class="delet-acc head-fix">
    ...
    <div class="common-inner">
      <div class="">
        <h5>Enter new mobile number</h5>
        <p>
          Verify mobile number to permanently change your account mobile number
        </p>
        <div class="form-group">
          <q-input v-model="text" label="Mobile No" />
        </div>
        <p class="flex justify-end"><q-btn class="btn3" label="Send OTP" /></p>
      </div>
      <div class="">
        <h5>{{$q.lang.common.changeMobNum.enterCode}}</h5>
        <p>Sent to +91 0000000000</p>
